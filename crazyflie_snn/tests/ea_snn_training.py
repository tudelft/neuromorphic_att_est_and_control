...
from crazyflie_snn.training.ea_rsnn import fit
...
if __name__ == "__main__":
    ...
    run = wandb.init(project=config["wandb"]["project"], entity=config["wandb"]["entity"], config=config, mode=wandb_mode)
